...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/hacks`, lastModified: now, changeFrequency: "daily", priority: 0.9 },
    { url: `${SITE_URL}/hot-takes`, lastModified: now, changeFrequency: "daily", priority: 0.9 },
    { url: `${SITE_URL}/movers`, lastModified: now, changeFrequency: "hourly", priority: 0.92 },
    { url: `${SITE_URL}/weekly`, lastModified: now, changeFrequency: "weekly", priority: 0.9 },
